...
contract CreatePoolAndAddLiquidityWithHookScript is Script, Constants, Config {
    ...
    function run() external {
        ...
        (address hookAddress, bytes32 salt) =
            HookMiner.find(CREATE2_DEPLOYER, flags, type(LimitOrder).creationCode, constructorArgs);
